...
class __TwigTemplate_ffc3f7412d56e3d05f768d3eadd24dba extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        if (CoreExtension::getAttribute($this->env, $this->source, ($context["app"] ?? null), "user", [], "any", false, false, false, 11)) {
            ...
            // line 13
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["app"] ?? null), "user", [], "any", false, false, false, 13), "username", [], "any", false, false, false, 13), "html", null, true);
            yield ", <a href=\"";
...
";
    ...
    {
        return array (  106 => 37,  100 => 24,  92 => 19,  87 => 16,  79 => 13,  76 => 12,  74 => 11,  71 => 10,  65 => 8,  63 => 7,  60 => 6,  56 => 5,  48 => 3,  37 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("", "security/login.html.twig", "/var/www/html/Dennis/myShop/templates/security/login.html.twig");
    }
}
