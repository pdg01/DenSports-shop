...
class __TwigTemplate_9d8bdb5f2550c11f3eb35a6b97f7ede5 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        // line 7
        yield         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["productForm"]) || array_key_exists("productForm", $context) ? $context["productForm"] : (function () { throw new RuntimeError('Variable "productForm" does not exist.', 7, $this->source); })()), 'form');
        yield "</div>
...
{% block body %}
    <div class=\"container\">
    {{ form(productForm) }}</div>

{% endblock %}
", "product/index.html.twig", "/var/www/html/Dennis/myShop/templates/product/index.html.twig");
    }
}
