...
class __TwigTemplate_ecbd9c0011392685fb0c968628ede4e9 extends Template
{
    private $source;
    private $macros = [];
...
<form method=\"post\">
    ...
    ";
        // line 37
        yield "
    <button class=\"btn btn-lg btn-secondary mt-4 mb-4 \" type=\"submit\">
        Sign in
    </button>

</form>
        <a class=\"mr-5 text-danger\" href=\"";
        // line 43
        yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getUrl("app_forgot_password_request");
...
";
    ...
    {
        return array (  148 => 44,  144 => 43,  136 => 37,  131 => 25,  123 => 20,  118 => 17,  110 => 14,  107 => 13,  105 => 12,  102 => 11,  96 => 9,  94 => 8,  90 => 6,  80 => 5,  60 => 3,  37 => 1,);
    }
...
<form method=\"post\">
    ...
    <button class=\"btn btn-lg btn-secondary mt-4 mb-4 \" type=\"submit\">
        ...
        <a class=\"mr-5 text-danger\" href=\"{{ url('app_forgot_password_request') }}\">Forgot password</a>
        <a class=\"text-dark\" href=\"{{ url('app_register') }}\">Register</a>
    </div>
{% endblock %}
", "security/login.html.twig", "/var/www/html/Dennis/myShop/templates/security/login.html.twig");
    }
}
