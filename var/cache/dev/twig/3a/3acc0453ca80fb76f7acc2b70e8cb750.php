...
class __TwigTemplate_7c08c9758cddedcacfbdf670fd78dcbd extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["user"]) {
            ...
            yield "</td>
                <td>";
            // line 24
            yield ((CoreExtension::getAttribute($this->env, $this->source, $context["user"], "isVerified", [], "any", false, false, false, 24)) ? ("Yes") : ("No"));
            yield "</td>
                <td>
                    <a href=\"";
            // line 26
...
{% endblock %}
", "user/index.html.twig", "/var/www/html/Dennis/myShop/templates/user/index.html.twig");
    }
}
